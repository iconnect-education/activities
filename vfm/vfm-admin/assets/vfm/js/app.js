...
// // Focus login form
// $("#call-login").on('click', function(event) {
        ...
        $(document).on('click', '#createlink', function() {
            ...
            $('.mailpreload').fadeIn('fast', function(){
                ...
                .done(function( response ) {
                    ...
                    var qrlink = msg.qrcode;
                    img = new Image();
                    img.onload = function() {
                        $('.mailpreload').fadeOut();
                        $('.qrcode-holder').html('<img style="min-width: 100px" class="w-100" src="' + qrlink + '">');
                    };
