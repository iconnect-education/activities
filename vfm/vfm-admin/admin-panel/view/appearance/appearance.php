        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-center mb-3 placeheader position-relative">
                    ...
                    <div class="pe-3">
                        <img class="app_ico-preview shadow-sm rounded" src="<?php echo $admin->printImgPlace('_content/uploads/favicon-168.png'); ?>?t=<?php echo time(); ?>" style="height: 76px; width: 76px;">
                    </div>
                    <div class="pe-3">
