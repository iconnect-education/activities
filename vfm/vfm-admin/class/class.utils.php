...
if (!class_exists('Utils', false)) {
    ...
    class Utils
    {
        ...
        /**
         * Normalize search term and file name
         *
         * @param string $src string to normalize
         *
         * @return $str
         */
        public static function normalizeSrc($src)
        {
            $str = Utils::unaccent($src);

            $replace = array(
                ' ' => '-',
                '_' => '-',
            );
            $cleanstring = strtr($str, $replace);
            return $cleanstring;
        }
